...
from .views import CreateUserProfileView, LoadUserProfileView, UpdateUserProfileView, DeleteUserProfileView, UpdateUserProfileTasks, LoadUserProfileTasksView, CreateUserProfileTaskView, DeleteUserProfileTask
