# Generated by Django 4.1.4 on 2023-04-10 01:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('not-started', 'Not-Started'), ('past-due', 'Past-Due'), ('started', 'Started'), ('complete', 'Complete')], default='not-started', max_length=11)),
