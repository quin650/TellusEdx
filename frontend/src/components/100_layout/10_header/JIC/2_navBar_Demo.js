...
const DemoNavbar = () => {
	...
	const [searchBarIsOpened, setSearchBarIsOpened] = useState(true);
	const [searchBarIsFocused, setSearchBarIsFocused] = useState(true);
	...
	let demoContent = (
		<Fragment>
			<li className={classes.LSideBar}>{sideBar_L_Button}</li>
			...
			<li className={classes.notesItem}>{sideBar_R_Notes_Button}</li>
			<li className={classes.mainItem}>{sideBar_R_Main_Button}</li>
