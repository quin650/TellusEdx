...
const DemoNavbar = () => {
	...
	const sideBar_Right_Search_Button = (
		<button onClick={open_sideBar_Right_Search_Modal} className={`${classes["toggleSearchMenuButton"]} ${sideBar_Right_Search_ModalStatus_rdx ? classes.open : ""}`}>
	...
	const sideBar_Right_Notes_Button = (
		<button onClick={open_sideBar_Right_Notes_Modal} className={`${classes["toggleNotesMenuButton"]} ${sideBar_Right_Notes_ModalStatus_rdx ? classes.open : ""}`}>
	...
	return (
		<nav className={classes.navContainer}>
			<div className={classes.inner_container_nav}>
				...
				{sideBar_Right_Main_ModalStatus_rdx && (
					<SideBar_R_MainModal open_sideBar_Right_Search_Modal={open_sideBar_Right_Search_Modal} open_sideBar_Right_Notes_Modal={open_sideBar_Right_Notes_Modal} />
				)}
