...
const DemoNavbar = () => {
	...
	const sideBar_R_Search_Button = (
		<button onClick={open_sideBar_R_Search_Modal} className={`${classes["toggleSearchMenuButton"]} ${sideBar_R_Search_ModalStatus_rdx ? classes.open : ""}`}>
	...
	const sideBar_R_Notes_Button = (
		<button onClick={open_sideBar_R_Notes_Modal} className={`${classes["toggleNotesMenuButton"]} ${sideBar_R_Notes_ModalStatus_rdx ? classes.open : ""}`}>
	...
	const sideBar_R_Main_Button = (
		<button
			...
			className={`${classes["hamburgerButton"]} ${
				(sideBar_R_Search_ModalStatus_rdx || sideBar_R_Notes_ModalStatus_rdx || sideBar_R_Main_ModalStatus_rdx) && classes.open_NavBarMenu
			}`}
		>
