...
import classes from "./2_passwordSubModal.module.css";
			...
			<div className={classes.subModalContainer}>
				...
				<ul className={classes.row}>
					<li className={`${classes["lower"]} ${isValidLower && classes.isValidLower}`}>
						<a className={`${classes["lowerX"]} ${isValidLower && classes.isValidLower}`}>Ｘ</a>
						<a className={`${classes["lowerCheck"]} ${isValidLower && classes.isValidLower}`}>✓</a>
						&nbsp;lowercase letter
					</li>
					<li className={`${classes["upper"]} ${isValidUpper && classes.isValidUpper}`}>
						<a className={`${classes["upperX"]} ${isValidUpper && classes.isValidUpper}`}>Ｘ</a>
						<a className={`${classes["upperCheck"]} ${isValidUpper && classes.isValidUpper}`}>✓</a>
						&nbsp;uppercase letter
					</li>
				</ul>
				<ul className={classes.row}>
					<li className={`${classes["number"]} ${isValidNumber && classes.isValidNumber}`}>
						<a className={`${classes["numberX"]} ${isValidNumber && classes.isValidNumber}`}>Ｘ</a>
						<a className={`${classes["numberCheck"]} ${isValidNumber && classes.isValidNumber}`}>✓</a>
						&nbsp;number
					</li>
					<li className={`${classes["special"]} ${isValidSpecial && classes.isValidSpecial}`}>
						<a className={`${classes["specialX"]} ${isValidSpecial && classes.isValidSpecial}`}>Ｘ</a>
						<a className={`${classes["specialCheck"]} ${isValidSpecial && classes.isValidSpecial}`}>✓</a>
						&nbsp;special character
					</li>
				</ul>
				<ul className={classes.row}>
					<li className={`${classes["eight"]} ${isValidEight && classes.isValidEight}`}>
						<a className={`${classes["eightX"]} ${isValidEight && classes.isValidEight}`}>Ｘ</a>
						<a className={`${classes["eightCheck"]} ${isValidEight && classes.isValidEight}`}>✓</a>
