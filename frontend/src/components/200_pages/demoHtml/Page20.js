	...
	return (
		<Fragment>
			...
			<div className={classes.page_content}>
				<p>
					Eventually, every driver will need to evaluate and assess their driving skills and abilities. If you are concerned about your driving, ask a trusted driver with a valid driver’s license to sit in the passenger seat and observe your driving. Your observer should note any dangerous driving
					behaviors and give suggestions for improvement. Listen carefully and apply what you have learned. Consider professional driving lessons or driving classes as an alternative.
				</p>
				<h2>Reexamination</h2>
				<p>
					The <em>Vehicle Code</em> allows DMV to investigate and reexamine every driver’s ability to operate a motor vehicle safely. A physical or mental condition or poor driver’s record can be the basis for a reexamination, not a driver’s age. Drivers with a physical or mental condition can be
					referred to DMV by a physician, law enforcement, or family member by submitting a completed Request for Driver Reexamination form.
				</p>
				...
				<p>If you come in contact with law enforcement and receive a Notice of Priority Reexamination of Driver with a check mark in the top box, carefully read the form. You have five working days to contact DMV to initiate the process or your driving privilege will be automatically suspended.</p>
