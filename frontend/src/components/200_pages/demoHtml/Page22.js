					...
					<table className="has-black-color has-white-background-color has-text-color has-background">
						...
						<tbody>
							...
							<tr>
								...
								<td data-title="Definition">
									Your BAC is the amount of alcohol in your blood. For example, if your BAC is 0.10%, that means you have 0.10 grams of alcohol in 100
							...
							<tr>
								...
								<td data-title="Definition">
									A pedestrian can also be a person with a disability using a tricycle, quadricycle, or wheelchair for transportation.
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td data-title="Definition">
									A driving rule that helps you estimate how closely you should follow other vehicles. When the vehicle in front of you passes a
									certain point, such as a sign, count three seconds. If you pass the same point before you finish counting, you are following too
									closely.
								</td>
							</tr>
							<tr>
								...
								<td data-title="Definition">
									Also known as a ticket, a traffic citation is an official summons issued by law enforcement for violating a traffic law.
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td data-title="Definition">
									Yield means to wait for, slow down, and be ready to stop (if necessary) to allow other vehicles or pedestrians who have right-of-way
									to proceed.
								</td>
							</tr>
						</tbody>
