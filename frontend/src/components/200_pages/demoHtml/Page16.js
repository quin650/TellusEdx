	...
	return (
		<Fragment>
			...
			<div className={classes.page_content}>
				...
				<p>There are also situations with specific speed limit laws and conditions where you should reduce your speed. Unless otherwise posted, the ideal maximum speed limit on most California highways is 65 mph. It is 55 mph on a two-lane undivided highway and for vehicles towing trailers.</p>
				<h2>Choose Between Hazards</h2> <p>Sometimes dangers will be on both sides of the road at the same time. For example, parked cars to the right and oncoming cars to the left.</p>
				<p>
					If one danger is greater than the other, give more space to the most dangerous situation. Suppose you are on a two-lane road with an oncoming vehicle to the left and a bicyclist ahead to your right. Instead of driving between the vehicle and the bicyclist, take one danger at a time. Slow
					down and let the oncoming vehicle pass. When the vehicle has passed, move to the left to allow plenty of space (at least three feet) to pass the bicyclist. If there is a steady flow of oncoming vehicles, use as much of the left lane as you safely can to pass the bicyclist.
				</p>
				<h2>Know How to Handle Emergencies</h2> <p>There are many types of emergencies you may encounter when you drive. Knowing how to handle emergencies can help keep you safe.</p> <h3>Tire Blowout</h3>
				<p>If you have a tire blowout, do not panic or overreact. Suddenly braking or abruptly removing your foot from the accelerator can result in a loss of control over the vehicle. Instead, you should take the following steps recommended by the National Highway Traffic Safety Administration:</p>
				<ul>
				...
				<p>Do not pull or turn your steering wheel with too much force. This may cause you to drive into oncoming traffic.</p> <h3>Overheating Conditions</h3> <p>In extreme heat, you should:</p>
				<ul>
				...
				<h4>California Highway Patrol (CHP) Freeway Service Patrol (FSP)</h4> <p>During commute times, the CHP FSP provides free emergency roadside services in certain areas. If you get stuck on the freeway because your vehicle stops running, FSP will:</p>
				<ul>
				...
				<h2>Cell Phones and Texting</h2> <p>Cell phones are the main source of distracted driving.&nbsp;Driving while using a handheld cell phone is unsafe and illegal.&nbsp;</p> <p>Adult drivers should only use a cell phone in hands-free mode when necessary.</p>
				<ul>
				...
				<h2>Minors And Cell Phones</h2> <p>It is against the law for a minor to use a cell phone or electronic wireless device to answer calls and send or respond to text messages while driving.</p>
				<p>
