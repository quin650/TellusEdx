		...
		<Fragment>
			...
			<div className={classes.page_content}>
				...
				<p>
					...
					<a href="http://dmv.ca.gov/addresschange">dmv.ca.gov/addresschange</a> or by mail. It is your responsibility to ensure DMV has your correct
				...
				<p>
					Before DMV can issue you a driver’s license, you may need to provide additional proof of your identity. Your driver’s license and identity
					document may expire on the same date. If so, you will be required to provide a valid identity document. If you are a minor, your parent or
					guardian must sign the application. Once you receive your replacement card, your old card is no longer valid. If you find the old card,
					destroy it.
				</p>
				...
				<p>
					If you are out-of-state and cannot renew, you may request a one year extension of your driver’s license. Before your driver’s license
					expires, submit a request with your name, driver’s license number, birth date, California residence address, and out-of-state address to{" "}
