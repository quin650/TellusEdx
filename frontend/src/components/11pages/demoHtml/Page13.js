		...
		<Fragment>
			...
			<div className={classes.page_content}>
				...
				<ul>
					...
					<li>
						<strong>Not</strong> interfere with a funeral procession. A funeral procession is led by a traffic officer and has the right-of-way. All vehicles taking part in the procession have windshield markers to identify them and have their headlights on. You can be ticketed if you interrupt a
						funeral procession.
					</li>
					<li>
				...
				<h3>Evading Law Enforcement</h3> <p>It is a misdemeanor to use a motor vehicle to flee or attempt to evade law enforcement performing their duties. This is punishable by imprisonment in a county jail for one year or less.</p>
				...
				<h3>Speed Contests and Reckless Driving</h3> <p>A person convicted of reckless driving or engaging in a speed contest that causes injury to another person is subject to imprisonment, a fine, or both.</p>
				<h3>Points on Your Driver’s Record</h3>
				<p>
					DMV monitors your driver’s record. If you are stopped by a law enforcement officer and cited (ticketed) for a traffic violation, you sign the ticket as a promise to appear in traffic court. As an adult or minor, if you get a traffic ticket and fail to appear (FTA) in court, DMV may suspend
					your driving privilege until you appear. If you do not keep your promise to appear in court, the FTA goes on your driver record.
				</p>
				<p>
					Each time you are convicted of a moving traffic violation, the court notifies DMV. The conviction is placed on your driver’s record. Convictions reported by other states and juvenile court are also added to your driver’s record. Traffic convictions and collisions stay on your record for 36
					months or longer, depending on the type of conviction. As an adult, your license may be suspended if your driver’s record shows one of the following point totals:
				</p>
				<ul>
				...
				<p>
					If you are given a one-point traffic violation, the judge may offer you the choice to attend a traffic violator school to have the citation not reported to your insurance company but remain on your driving record. You can do this once in any 18-month period. The school will report your
					course completion to the court. You will also get a completion receipt.
				</p>
				<p>
				...
				<p>
					If you have too many points on your driver’s record, you will be considered a negligent driver. DMV will place you on probation, suspend, or revoke your driving privilege. When this happens, you have the right to a hearing. DMV will notify you in writing of any action taken against your
					driving privilege and inform you of your legal rights, including your right to a hearing.
				</p>
				...
				<p>At the end of your suspension or revocation, you may apply for a replacement driver’s license. You must show proof of financial responsibility (such as SR 22/SR 1P).</p> <h3>Maintaining Your Minor’s (Provisional) Driver’s License</h3>
				...
				<p>
					Administrative hearings are conducted by DMV. If you received notification that a proposed action is being taken against your driving privilege, you must request a hearing within 10 days of being served or 14 days from the date the notice is mailed. If you do not make a timely request,
					your right to a hearing will be lost.
				</p>
				...
				<h2>Record Confidentiality</h2> <p>Most information in your driver’s record is available to the public, except physical or mental conditions, address, and social security number.</p>
				<p>
