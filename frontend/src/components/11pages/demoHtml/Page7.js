	...
	return (
		<Fragment>
			<div className={classes.handbook_header_section}>
				<p>Page 7 of 22 </p>
				<h2>Section 4: Changing, Replacing, and Renewing Your Driver’s License</h2>
			</div>
			<div className={classes.page_content}>
				...
				<p>
					Before DMV can issue you a driver’s license, you may need to provide additional proof of your identity. Your driver’s license and identity document may expire on the same date. If so, you will be required to provide a valid identity document. If you are a minor, your parent or guardian
					must sign the application. Once you receive your replacement card, your old card is no longer valid. If you find the old card, destroy it.
				</p>
