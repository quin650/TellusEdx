			...
			<div className={classes.page_content}>
				...
				<div className={classes.imageDivColContainer}>
					<div className={classes.imageDivCol}>
						...
						<p>
							When you are in a collision, your vehicle stops. But you keep moving at the same speed you were traveling. You only stop when you hit the dashboard or windshield. If you are struck from the side, the impact could push you back and forth across the seat. Seat and shoulder belts keep you
							in a better position to control the vehicle. They may also minimize serious injuries.
						</p>
				...
				<h3>Child Restraint System and Safety Seats</h3> <p>You must secure children with a federally-approved child passenger restraint system or safety belt. The requirements depend on the child’s height and age.</p>
				<ul>
					<li>
				...
				<ul>
					<li>
						<strong>Children who are under 8 years old, or who are less than 4 feet 9 inches tall:</strong> Secure in a child passenger restraint system in a rear seat. In some cases, children under 8 years old may ride in the front seat of a vehicle in a federally-approved child passenger restraint
						system. They may ride in the front seat if:
						<ul>
				...
				<p>Your local law enforcement agency or fire department can check the installation of your child passenger restraint system. As your child grows, check that the child passenger restraint system is the right size.</p> <h3>Air Bags</h3>
				<p>Air bags are a valuable safety feature on many vehicles. They can help keep you safer than a seat belt alone.</p>
				<p>
					Ride at least 10 inches from the airbag cover, as long as you can maintain full control of your vehicle. Measure from the center of the steering wheel to your breastbone. Contact your vehicle dealer or manufacturer if you cannot safely sit 10 inches away from the air bag. They may have
					advice about additional ways to move back from your air bag. Passengers should also sit at least 10 inches away from the passenger-side air bag.
				</p>
				<p>
					<span role="region" aria-label="Note" className={classes.formatLabelNote}>
				...
				<h3>Unattended Children and Pets</h3> <p>It is illegal to leave a child who is six years old or younger unattended in a vehicle. A child may be left under the supervision of a person who is at least 12 years old.</p>
				<p>
