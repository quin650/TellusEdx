	...
	return (
		<Fragment>
			...
			<div className={classes.page_content}>
				...
				<p>
					Make sure you read medication labels and know the effects of any drug you use.&nbsp; If a law enforcement officer thinks you are driving while under the influence of drugs or alcohol, they have the right to ask you to take a blood or urine test. If you refuse to take one, DMV will suspend
					or revoke your driving privilege for one year.
				</p>
				<p>
				...
				<p>
					The law is very strict about carrying alcohol or cannabis products in your vehicle with you. It is illegal to drink any alcohol, to smoke or eat a cannabis product while you are driving or riding as a passenger in a vehicle. If you are carrying any alcohol, cannabis in your vehicle, the
					container must be sealed and unopened. If it is open, you must keep the container in the trunk or place where passengers do not sit. It is also illegal to keep an open container of alcohol in your glove box. This law does not apply if you are a passenger in a bus, taxi, camper, or
					motorhome.
				</p>
				<h2>Blood Alcohol Concentration (BAC) Limits</h2> <p>When you consume alcohol, traces of it enter your bloodstream. Your BAC measures how much alcohol is present in your bloodstream.</p> <p>It is illegal for you to drive if you have a BAC of:</p>
				<ul>
				...
				<p>
					If you drive with an illegal BAC, a law enforcement officer can charge you with DUI. Even if your BAC is below legal limits, that does not mean it is safe for you to drive. Almost everyone feels negative effects of alcohol, even at levels lower than the legal limit. Depending on how badly
					you are impaired, you may be arrested and convicted of a DUI even without a BAC measurement.
				</p>
				...
				<h2>DUI Arrests</h2>
				<p>
					When you drive in California, you consent to a breath, blood, or urine test if a law enforcement officer suspects you of DUI.&nbsp; If you agreed to take a preliminary alcohol screening (PAS) or breath test, you may still be required to take a blood or urine test to detect the presence of
					drugs.&nbsp; If you refuse, DMV will suspend or revoke your driving privilege. If you are arrested for DUI:
				</p>
				<ul>
				...
				<p>All DUI convictions remain on your driver’s record for 10 years. If you get any other DUIs during that time, the court or DMV may give you an additional penalty.</p> <h2>Drivers Under 21</h2>
				...
				<ul>
					...
					<li>
						If you are caught with alcohol in your vehicle, law enforcement can impound your vehicle for up to 30 days. The court may fine you and suspend your driver’s license for one year. If you do not already have a driver’s license, the court may ask DMV to delay giving you your first driver’s
