	...
	return (
		<Fragment>
			...
			<div className={classes.page_content}>
				...
				<h3>Scan Your Surroundings</h3> <p>To give yourself time to react, avoid last minute moves and hazards, always keep your eyes moving and scan the road at least 10 seconds ahead of your vehicle.&nbsp;</p>
				...
				<h3>Blind Spots</h3> <p>Every vehicle has blind spots. These are areas around the vehicle that a driver cannot see when looking straight ahead or using the mirrors. For most vehicles, the blinds spots are at the sides, slightly behind the driver.</p>
				...
				<h3>Know What is Behind You</h3> <p>Knowing what is behind you can help you avoid rear-end collisions. Check traffic behind you often by using your rearview mirror, side mirrors, and turning your head when you:</p>
				<ul>
				...
				<p>
					When driving at night, use your high-beam headlights on open country roads or dark city streets. Make sure you can stop in the distance lit by your headlights. Do not use high-beam headlights in areas where they are illegal. Dim your high-beam headlights to avoid blinding the driver of an
					oncoming vehicle. If another vehicle’s lights are too bright:
				</p>
				<ul>
				...
				<h3>Skids</h3> <p>A skid is when one or more of the tires lose traction with the road and the vehicle starts to slip. You may not be able to control your vehicle. There are a few different types of skids.</p>
				...
				<p>If your brakes get wet, you can dry them by lightly pressing the accelerator and brake pedals at the same time. Only do this until the brakes dry.</p> <h3>Slippery Roads</h3>
				...
				<p>
					Turn on your windshield wipers, low-beam headlights, and defroster. In a heavy rainstorm or snowstorm, you may not be able to see more than 100 feet in front of your vehicle. If you cannot see farther than 100 feet, it is not safe to drive faster than 30 mph. You may have to stop from time
					to time to wipe mud or snow off your windshield, headlights, and taillights. If you drive in snowy areas, carry snow chains for your tires. Snow chains give your tires more traction. Carry the correct number and type of chains for your vehicle.
				</p>
				<h3>Hydroplaning</h3>
				<p>Hydroplaning occurs when driving in wet or rainy conditions. Hydroplaning is a vehicle riding on water because the tires lose all contact with the road. A slight change of direction, applying the brakes, or a gust of wind could throw the vehicle into a skid. To avoid hydroplaning:</p>
				<ul>
				...
				<h3>Flooded Roads</h3> <p>Excessive water on a road may cause flooding. This can happen gradually or suddenly. It is important to understand the dangers of water on the road, including:</p>
				<ul>
				...
				<p>
					It may not be possible to determine the depth of the flood by looking. If the water is deep, the road may be too dangerous to cross. It is best to find another route. If you have no other option but to drive through a flooded road, drive slowly. After you make it through the water, test
					your brakes to make sure they work correctly.
				</p>
				<h3>High Winds</h3> <p>High winds can be a hazard while driving. This is especially true for larger vehicles such as trucks, campers, and vehicles with trailers. When driving in high winds:</p>
				<ul>
				...
				<h3>Fog or Heavy Smoke</h3> <p>It is best to avoid driving in heavy fog or smoke. Consider postponing your trip until the fog clears. If you must drive in heavy fog or smoke:</p>
				<ul>
				...
				<p>If the fog becomes too thick to drive safely, consider pulling off the road. Activate your emergency flashers and wait for conditions to improve.</p> <h3>Law Enforcement Traffic Breaks</h3>
