	...
	return (
		<Fragment>
			<div className={classes.handbook_header_section}>
				<p> Page 18 of 24 </p> <h1>Section 8: Safe Driving (Continued)</h1>
			</div>
			<div className={classes.page_content}>
				...
				<p>
					There are also situations with specific speed limit laws and conditions where you should reduce your speed. Unless otherwise posted, the ideal maximum speed
					limit on most California highways is 65 mph. It is 55 mph on a two-lane undivided highway and for vehicles towing trailers.
				</p>
				<h2>Choose Between Hazards</h2>{" "}
				<p>Sometimes dangers will be on both sides of the road at the same time. For example, parked cars to the right and oncoming cars to the left.</p>
				<p>
					If one danger is greater than the other, give more space to the most dangerous situation. Suppose you are on a two-lane road with an oncoming vehicle to the
					left and a bicyclist ahead to your right. Instead of driving between the vehicle and the bicyclist, take one danger at a time. Slow down and let the oncoming
					vehicle pass. When the vehicle has passed, move to the left to allow plenty of space (at least three feet) to pass the bicyclist. If there is a steady flow of
					oncoming vehicles, use as much of the left lane as you safely can to pass the bicyclist.
				</p>
				<h2>Know How to Handle Emergencies</h2>{" "}
				<p>There are many types of emergencies you may encounter when you drive. Knowing how to handle emergencies can help keep you safe.</p> <h3>Tire Blowout</h3>
				<p>
					If you have a tire blowout, do not panic or overreact. Suddenly braking or abruptly removing your foot from the accelerator can result in a loss of control over
					the vehicle. Instead, you should take the following steps recommended by the National Highway Traffic Safety Administration:
				</p>
				<ul>
					<li>Hold the steering wheel with both hands.</li> <li>Maintain your vehicle speed if possible and safe.</li> <li>Gradually release the accelerator.</li>{" "}
					<li>Correct the steering as necessary to stabilize your vehicle and regain control.</li>
				...
				<ol>
					<li>Grip the steering wheel firmly.</li> <li>Remove your foot from the accelerator.</li> <li>Brake gently.</li> <li>Check for traffic behind you.</li>{" "}
					<li>Carefully steer back onto the pavement.</li>
				</ol>
				<p>Do not pull or turn your steering wheel with too much force. This may cause you to drive into oncoming traffic.</p> <h3>Overheating Conditions</h3>{" "}
				<p>In extreme heat, you should:</p>
				<ul>
				...
				<ol>
					<li>Safely pull over to the right shoulder.</li> <li>Exit on the right side so you are away from traffic if you must get out of the vehicle.</li>{" "}
				...
				<p>
					During commute times, the CHP FSP provides free emergency roadside services in certain areas. If you get stuck on the freeway because your vehicle stops
					running, FSP will:
				</p>
				<ul>
					<li>Provide a gallon of gas if you run out.</li> <li>Jump start your vehicle if the battery is dead.</li> <li>Refill your radiator and tape hoses.</li>{" "}
					<li>Change a flat tire.</li> <li>Report a collision to CHP.</li>
				</ul>
				<p>If FSP cannot start your vehicle, they will have it towed (free of charge) to a CHP-approved location. CHP will notify an auto club or towing service.</p>{" "}
				<p>FSP will not:</p>
				<ul>
					<li>Tow your vehicle to a private repair service or residence.</li> <li>Recommend tow service companies or repair and body shops.</li> <li>Tow motorcycles.</li>{" "}
					<li>Help vehicles which have been involved in a collision, unless they are directed to by CHP.</li>
				</ul>
				...
				<div className={classes.imageDivColContainer}>
					<div className={classes.imageDivCol}>
						...
						<ul>
							<li>
								Exit your vehicle. Dial the number located on the railroad crossing posts or metal control box near the tracks. Provide the crossing number (if posted).
								Tell them a vehicle is on the tracks. Then call 911.
							</li>
						</ul>
					</div>
					<div className={classes.imageDivCol}>
				...
				<ul>
					<li>Do not answer your cell phone if it rings. Let the call go to voicemail. If you must return or make a call, pull safely off the road.</li>{" "}
				...
				<p>It is against the law for a minor to use a cell phone or electronic wireless device to answer calls and send or respond to text messages while driving.</p>
				<p>
				...
				<p>
					The technology in vehicles is always advancing. We will see more self-driving vehicles and vehicles with advanced driver assistance systems (ADAS) on the road.
					Vehicles with these systems may respond to road situations differently than a human driver would.
				</p>
				<h2>Be Aware of Carbon Monoxide</h2>
				<p>
					All gas-powered vehicles produce carbon monoxide. Carbon monoxide is a deadly odorless gas released from a vehicle’s exhaust pipe. Never start your vehicle
					inside the garage with the door closed. Symptoms of carbon monoxide poisoning include:
				</p>
				<ul>
