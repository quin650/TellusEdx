	...
	return (
		<Fragment>
			...
			<div className={classes.page_content}>
				...
				<p>
					<strong>Hearing </strong>– You must be able to hear horns, sirens, motorcycles, or screeching tires that may alert you of hazards. It is illegal to wear a
				...
				<p>
					<strong>Physical and Mental</strong> – You must be alert to quickly decide the correct course of action in any type of traffic situation, including unexpected
					ones.
				</p>

				<p>
					<strong>Medications</strong> – Prescription and over-the-counter medications can make you an unsafe driver. Some medicines can make you sleepy. It is your
					responsibility to know the effects of the medications you take.
				</p>

				<p>
					<strong>Health </strong>– Physicians are required to report patients, who are at least 14 years old, to DMV if they believe you have medical conditions that may
				...
				<p>
					You can signal using your vehicle’s signal lights or using hand-and-arm positions. If your signal lights are not functioning, or bright sunlight makes your
					signal lights hard to see, use the hand-and-arm signals shown in the image below.
				</p>
				...
				<p>
					Your vehicle’s headlights help you see what is in front of you. They also make it easier for other drivers to see your vehicle. Dim your high-beam headlights to
					low beams within 500 feet of a vehicle coming toward you or within 300 feet of a vehicle you are following. It is illegal to drive using only parking lights.
					Use your headlights:
				</p>
