		...
		<form onSubmit={submitHandler}>
			<div className={classes.inputForm_container}>
				<section className={`${classes["input_section"]} ${!isValid && classes.invalid}`}>
					...
					<input type="text" placeholder={`${task_title_global}`} name="task_title" ref={task_title} defaultValue={`${task_title_global}`} />
				</section>
				<section className={`${classes["input_section"]} ${!isValid && classes.invalid}`}>
					<label> Task Description </label>
					<input type="text" placeholder={`${task_description_global}`} name="task_description" ref={task_description} defaultValue={`${task_description_global}`} />
				</section>
				<section className={`${classes["input_section"]} ${!isValid && classes.invalid}`}>
					<label> Task Tags </label>
					<input type="text" placeholder={`${task_tags_global}`} name="task_tags" ref={task_tags} defaultValue={`${task_tags_global}`} />
				</section>
				<section className={`${classes["input_section"]} ${!isValid && classes.invalid}`}>
					<label> Task Order </label>
					<input type="text" placeholder={`${task_order_global}`} name="task_order" ref={task_order} defaultValue={`${task_order_global}`} />
				</section>
				<section className={`${classes["input_section"]} ${!isValid && classes.invalid}`}>
				...
				<section className={`${classes["input_section"]} ${!isValid && classes.invalid}`}>
					...
					<input type="text" placeholder={`${task_links_global}`} name="task_links" ref={task_links} defaultValue={`${task_links_global}`} />
				</section>
				<section className={`${classes["input_section"]} ${!isValid && classes.invalid}`}>
					<label> Task Due Date </label>
					<input type="text" placeholder={`${task_due_date_global}`} name="task_due_date" ref={task_due_date} defaultValue={`${task_due_date_global}`} />
				</section>
