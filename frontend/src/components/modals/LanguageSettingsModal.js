...
import { login_APIAction, register_APIAction, verifyAccount_APIAction, verifyAccountResendPassCode_APIAction, resetPasswordSendPassCode_APIAction, resetPasswordChange_APIAction } from "../../../src/a.actions/auth_Actions";
...
const LanguageSettingsModal = () => { 
    ...
    const GoTo_VerifyAccountModal = () => {
        ...
        setFormOptions(<span className={classes.optionSpan}><p className={classes.optionsText}>Didn't get code?<a onClick={Send_PassCodeLink} className={classes.PageLink}> Resend </a></p></span>);
    };
