...
const NavbarMenu = () => {
    ...
    let option = (<a onClick={LogInHandler} className={classes.menuItem}><i className={classes.icon} onClick={LogInHandler}>{logInIcon}</i><span>Log in</span></a>)
    isAuthenticated
    ? option = (<a onClick={LogOutHandler} className={classes.menuItem}><i className={classes.icon} onClick={LogOutHandler}>{logOutIcon}</i><span>Log in</span></a>)
    : option = (<a onClick={LogInHandler} className={classes.menuItem}><i className={classes.icon} onClick={LogInHandler}>{logInIcon}</i><span>Log in</span></a>)
        ...
        <div className={classes.blurredBackgroundContainer}>
            ...
            <menu className={classes.sidebar}>
                <div className={classes.sidebarHeader}>
                    <img src="" alt="Logo" className={classes.logo} /><span className={classes.brandName}>TellusEd</span>
                </div>
