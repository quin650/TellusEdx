...
const SideBar_R_Questions_layoutFeatures = ({ getHint }) => {
	...
	let taskBarButton = (
		<li>
			<Tippy content={footerTaskBarTippyText} placement="top" theme="custom" appendTo="parent">
				<button aria-label="TaskBar Button" onClick={taskBarButtonAction} className={classes.footerButton}>
	...
	const lightBulbButton = (
		<li>
			<Tippy content="Hint" placement="top" theme="custom" appendTo="parent">
				<button aria-label="Hint Button" onClick={lightBulbButtonAction} className={classes.footerButton}>
					<svg
	...
	const testResultsButton = (
		<li>
			<Tippy content="Test Results" placement="top" theme="custom" appendTo="parent">
				<button aria-label="Test Results" onClick={testResultsButtonAction} className={classes.footerButton}>
					<svg
	...
	const bookMarkButton = (
		<li>
			<Tippy content="Bookmark" placement="top" theme="custom" appendTo="parent">
				<button aria-label="BookMark Button" onClick={bookMarkButtonAction} className={classes.footerButton}>
	...
	const commentBubbleButton = (
		<li>
			<Tippy content="Comments" placement="top" theme="custom" appendTo="parent">
				<button aria-label="Comments Button" onClick={commentBubbleButtonAction} className={classes.footerButton}>
					<svg
	...
	const thumbsUpButton = (
		<li>
			<Tippy content="Like" placement="top" theme="custom" appendTo="parent">
				<button aria-label="Dislike Button" onClick={thumbsUpButtonAction} className={classes.footerButton}>
	...
	return (
		<Fragment>
			<div className={`${classes["handbook_taskbar_container_Outer"]} ${allowFooterOnHover ? classes.allowHover : ""}`}>
				<div className={`${classes["handbook_taskbar_container_Inner"]} ${sideBar_R_Questions_FooterTaskBarIsPinnedOpen_rdx ? classes.open : ""}`}>
					{taskBarButton}
					{lightBulbButton}
					{testResultsButton}
					{bookMarkButton}
...
export default SideBar_R_Questions_layoutFeatures;
