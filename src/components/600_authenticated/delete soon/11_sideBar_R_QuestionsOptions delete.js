...
const SideBar_R_QuestionsOptions = () => {
	...
	useEffect(() => {
		...
		// console.log("testResultsData_listForm:", testResultsData_listForm);
		...
		for (let testNum_idx = 0; testNum_idx < testResultsData_listForm.length; testNum_idx++) {
			...
			for (let questionNum_idx = 0; questionNum_idx < testData_object.length; questionNum_idx++) {
				...
				// console.log(`1. Iterate through test# ${testNum}, question# ${questionNum}---------------------------------`);
				// console.log("Initial value of sideBar_R_Questions_NextTestNumber_idx_toReAttempt:", sideBar_R_Questions_NextTestNumber_idx_toReAttempt);
				// console.log("Initial value of sideBar_R_Questions_NextQuestionNumber_idx_toReAttempt:", sideBar_R_Questions_NextQuestionNumber_idx_toReAttempt);
				...
				if (initialAttempt_gotCorrect) {
					// console.log("2. initial attempt got correct");
				}
				if (!initialAttempt_gotCorrect) {
					// console.log("3. initial attempt got incorrect");

					if (question_wasReAttempted) {
						// console.log("5. Question was re-attempted");
						// console.log("5.1. set the last test/question re-attempted as current test/question");
					...
					if (
						...
						// console.log(`6. Question was not re-attempted`);
						// console.log(`!question_wasReAttempted: ${!question_wasReAttempted}`);
						// console.log(`sideBar_R_Questions_NextTestNumber_idx_toReAttempt: ${sideBar_R_Questions_NextTestNumber_idx_toReAttempt}`);
						// console.log(`!sideBar_R_Questions_NextTestNumber_idx_toReAttempt: ${!sideBar_R_Questions_NextTestNumber_idx_toReAttempt}`);
						...
						// console.log(`6.3. Assigned sideBar_R_Questions_NextTestNumber_num_toReAttempt: ${sideBar_R_Questions_NextTestNumber_num_toReAttempt}`);
						// console.log(`6.4. Assigned sideBar_R_Questions_NextQuestionNumber_num_toReAttempt: ${sideBar_R_Questions_NextQuestionNumber_num_toReAttempt}`);
					}
				}
			}
		}
		// console.log("7.1 Checking conditions for updating NextTestNumber_toReAttempt:");
		// console.log("7.2 sideBar_R_Questions_NextTestNumber_idx_toReAttempt !== null: ", sideBar_R_Questions_NextTestNumber_idx_toReAttempt !== null);
		// console.log("7.3 sideBar_R_Questions_NextTestNumber_idx_toReAttempt !== undefined: ", sideBar_R_Questions_NextTestNumber_idx_toReAttempt !== undefined);
		// console.log("7.4 sideBar_R_Questions_NextTestNumber_idx_toReAttempt_rdx === null: ", sideBar_R_Questions_NextTestNumber_idx_toReAttempt_rdx === null);
		// console.log("sideBar_R_Questions_NextTestNumber_idx_toReAttempt: ", sideBar_R_Questions_NextTestNumber_idx_toReAttempt);
		if (
			...
			// console.log(`7.5 🔄 Dispatching Redux: NextTestNumber_toReAttempt = ${sideBar_R_Questions_NextTestNumber_num_toReAttempt}`);

			dispatch(userReducerActions.sideBar_R_Questions_setRetakeFailedQuestions_moduleIsActive(true));
		}
		// console.log("8.1 Checking conditions for updating NextQuestionNumber_toReAttempt:");
		// console.log("8.2 sideBar_R_Questions_NextQuestionNumber_idx_toReAttempt !== null: ", sideBar_R_Questions_NextQuestionNumber_idx_toReAttempt !== null);
		// console.log("8.3 sideBar_R_Questions_NextQuestionNumber_idx_toReAttempt !== undefined: ", sideBar_R_Questions_NextQuestionNumber_idx_toReAttempt !== undefined);
		// console.log("sideBar_R_Questions_NextQuestionNumber_idx_toReAttempt_rdx === null ", sideBar_R_Questions_NextQuestionNumber_idx_toReAttempt_rdx === null);
		// console.log("sideBar_R_Questions_NextQuestionNumber_idx_toReAttempt: ", sideBar_R_Questions_NextQuestionNumber_idx_toReAttempt);
		if (
			...
			// console.log(`8.5 🔄 Dispatching Redux: NextQuestionNumber_toReAttempt = ${sideBar_R_Questions_NextQuestionNumber_num_toReAttempt}`);
		}
	}, []);
