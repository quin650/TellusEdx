...
import GetStartedButton from "../../3000_modals/10_modal_getStarted/getStartedFeatures/1_getStartedButton";
import Modal_getStarted from "../../3000_modals/10_modal_getStarted/modal_getStarted";
import Modal_languageSettings from "../../3000_modals/20_modal_languageSettings/1_modal_languageSettings";
import SideBar_R_MainMenu from "../../4000_sideBars/30_sideBar_R_MainMenu/sideBar_R_MainMenu";
...
const MainNavbar = () => {
	...
	const sideBar_L_Button = (
		<Tippy content={"Table of Contents"} placement="bottom" theme="custom" appendTo="parent">
	...
	const sideBar_R_Notes_Button = (
		<Tippy content={"Notes"} placement="left" theme="custom" appendTo="parent">
	...
	const sideBar_R_Main_Button = (
		<Tippy content={"Menu"} placement="bottom" theme="custom" appendTo="parent">
			<button
	...
	const sideBar_R_Questions_Button = (
		<Tippy content={"Test"} placement="left" theme="custom" appendTo="parent">
