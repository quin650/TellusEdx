	...
	return (
		<div className={classes.handbook_outerContainer2} ref={questionContentRef}>
			<div className={classes.page_contentContainer}>
				...
				<button aria-label="Reset This Test" onClick={modal_action_resetThisTest_open} className={`${classes["viewTestResults"]} ${true ? classes.testIsComplete : ""}`}>
					<p>Reset this test</p>
				...
				<div className={classes.buttonCancelSection}>
					<button aria-label="Back Button" className={classes.button_formatBack} onClick={backButtonAction} type="submit">
						Back
					</button>
					<button aria-label="Go to Next Test" className={classes.button_formatSubmit} onClick={gotoNexTest} type="submit" disabled={!(lastSubmittedQuestion === 36)}>
						Next Test
					</button>
				</div>
			</div>
