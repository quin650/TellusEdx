	...
	return (
		<Fragment>
			<div className={classes.handbook_header_section}>
				<p>Page 11 of 24 </p>
				<h1 id="Section 6: Navigating the Roads">Section 6: Navigating the Roads</h1>
			</div>
			<div className={classes.page_content}>
				...
				<p>
					A single solid yellow line marks the center of a road with two-way traffic. Do not pass a vehicle in front of you if there is only one lane of traffic going
					your direction and a solid yellow line on your side of the road.
				</p>
				...
				<p>
					Two sets of solid double yellow lines spaced two or more feet apart are considered a barrier. Do not drive on or over this barrier, make a left turn, or make a
				...
				<p>
					Double solid white lines indicate a lane barrier between a regular use and a preferential use lane, such as a carpool (HOV) lane. You may also see double solid
					white lines in or near freeway on and off ramps. Never change lanes over double solid white lines. Wait until you see a single broken white line.
				</p>
				...
				<p>
					Ending freeway and street lanes are usually marked with large broken lines. If you are driving in a lane marked with broken lines, be prepared to exit the
					freeway or for the lane to end. Look for a sign that tells you to exit or merge.
				</p>
				<h4>Yield Line</h4>
				...
				<p>
					Traffic lanes are often referred to by number. The left (or fast) lane is called the Number 1 Lane. The lane to the right of the Number 1 Lane is called the
					Number 2 Lane. Then the Number 3 Lane, etc.
				</p>
				<div className={classes.imageDiv}>
					<figure>
						<img
						...
						/>
						<figcaption>Example of numbered traffic lanes</figcaption>
					</figure>
				</div>
				...
				<p>
					Stay in one lane as much as possible. Do not weave in and out of traffic. Last minute lane or direction changes may increase the risk of collisions. Once you
					start moving through an intersection, keep going. If you start to make a turn, follow through. If you miss a turn, keep driving until you can safely and legally
					turn around.
				</p>
				...
				<ul>
					<li>
						You have a certain number of people in your vehicle. There will be signs at the on-ramp or along the road to tell you the minimum number of people. Road signs
						also list the hours when the HOV rules apply.
					</li>
				...
				<p>
					A center left turn lane is located in the middle of a two-way street. It is marked on both sides by two painted lines. The inner line is broken and the outer
					line is solid. Use the center left turn lane to prepare for and make a left turn or U-turn. It is not a regular traffic lane or passing lane. You may only drive
					for 200 feet in the center left turn lane. To turn left from this lane:
				</p>
				<div className={classes.imageDivColContainer}>
					<div className={classes.imageDivCol}>
						<ul>
					...
					<div className={classes.imageDivCol}>
						<figure className="wp-block-image size-full is-resized">
							...
							/>
							<figcaption>Example of Center Left Turn Lane</figcaption>
						</figure>
					</div>
				</div>
				...
				<p>
					You must use a turnout area or lane to let other vehicles pass when you are driving slowly on a two-lane road, where passing is unsafe, and there are five or
					more vehicles following you.
				</p>
				<h4>Bicycle Lanes</h4>
				<p>
					Bicycle lanes are for bicyclists only and run alongside vehicle traffic. They are typically marked by a single solid white line and signs. They are sometimes
					painted bright green to make them easier to see.
				</p>
				<div className={classes.imageDiv}>
					<figure>
						<img
						...
						/>
						<figcaption>Example of shared roadway.</figcaption>
					</figure>
				</div>
				...
				<ul>
					<li>
						<strong>Bike lane:</strong> Established along streets adjacent to vehicle traffic.&nbsp; Typically marked by a single solid white line that turns into a
						dash-line near an intersection.
					</li>
					<li>
					...
					<li>
						<strong>Bike route:</strong> Uses bike route signs and shared road markings to designate a preferred route for bicyclists on streets shared with vehicle
						traffic.
					</li>
					<li>
					...
					<li>
						<strong>Separated bikeway:</strong> Is physically separated from motor vehicle traffic and for exclusive use of bicyclists. They are also known as a cycle
						track or protected bike lanes. The separation may include flexible posts, grade separation, inflexible barriers, or on-street parking.
					</li>
					<li>
						<strong>Shared roadway bicycle markings:</strong> Alert drivers that bicyclists can occupy the lane and help bicyclists maintain a safe lane position in
						traffic.
					</li>
				</ul>
				<p>
					<span role="region" aria-label="Note" className={classes.formatLabelNote}>
						Check your blind spots before entering a bike lane. If you drive a motorized bicycle, use caution to avoid other bicyclists. Travel at a reasonable speed and
						do not endanger the safety of other bicyclists.
					</span>
				</p>
				<h2>Turns</h2>
				<h3>Right Turns</h3>
				...
				<ul>
					...
					<li>
						Stop behind the limit line. A limit line is a wide white line that shows the drivers where to stop before an intersection or crosswalk. If there is no limit
						line, stop before you enter the crosswalk. If there is no crosswalk, stop before you enter the intersection.
					</li>
				...
				<p>
					It is illegal to drive, stop, park, or leave a vehicle in an area designated for public transit buses. Signs will be posted to indicate the lanes are for bus
					only use. However, you may cross a bus lane to make a right turn.
				</p>
				<h4>Right Turn onto a Road with a Dedicated Lane</h4>
				<p>
					A dedicated right turn lane does not merge into another lane and allows you to make a right turn without stopping. You may make your turn even if there is a red
					light for vehicles going straight through the intersection. If there is a traffic light or sign on the right curb of the right turn lane, you must obey that
					light or sign. Always yield to pedestrians in a crosswalk when turning.
				</p>
				<figure>
					<img
						loading="lazy"
					...
					/>
					<figcaption>Example of a Right Turn into a Dedicated Lane</figcaption>
				</figure>
				<h3>Left Turns</h3>
				<div className={classes.imageDiv}>
					<figure>
						...
						/>
						<figcaption>Example of a left turn.</figcaption>
					</figure>
				</div>
				<p>To turn left:</p>
				<ul>
					<li>
						...
						<ul>
							...
							<li>
								Enter a two-way center left turn lane within 200 feet of the turn. Respect the right-of-way of any vehicle, bicyclist, or motorcyclist already in the
								lane. Always yield to pedestrians.
							</li>
						</ul>
					</li>
					...
					<li>
						...
						<ul>
							<li>
								Keep your wheels pointed straight ahead until it is safe to start your turn. If your wheels are pointed to the left and a vehicle hits you from behind,
				...
				<p>
					You may turn left against a red light when you are turning from a one-way street onto a one-way street. Make sure there is no sign prohibiting the turn. Yield
					to other vehicles, pedestrians, or bicyclists who have a green light. Look both ways and turn when it is safe.
				</p>
				<h3>U-turns</h3>
				<p>
					A U-turn is when you turn your vehicle around to go back in the direction you came. To make a U-turn, signal and use the left turn lane or far-left lane. You
					may make a U-turn:
				</p>
				<ul>
				...
				<p>
					The descriptions below refer to the numbers next to the cars in the images. Watch for pedestrians, motorcycles, and bicycles between your vehicle and the curb.
					When making turns, there may be signs or arrows that indicate you can turn from or end in more than one lane.
				</p>
				<ol>
					<li>
						<strong>Left turn from a two-way street.</strong> Start the turn in the left lane closest to the middle of the street. To reduce the risk of collision, end
						the turn in the left lane closest to the middle of the street going in your vehicle’s direction.
					</li>
				</ol>
				<div className={classes.imageDiv}>
				...
				<p>
					3. <strong>Left turn from a two-way street onto a one-way street.</strong> Start the turn from the lane closest to the middle of the street (far-left lane). If
					there are three or more lanes in your direction of travel, you may end your turn in any lane that is open.
				</p>
				<figure>
					<img
						loading="lazy"
				...
				<p>
					4. <strong>Left turn from a one-way street onto a two-way street. </strong>Start the turn from the far-left lane. To reduce the risk of collision, end the turn
					in the left lane closest to the middle of the street going in your vehicle’s direction.
				</p>
				<figure>
					<img
						loading="lazy"
				...
				<p>
					5. <strong>Left turn from a one-way street onto a one-way street.</strong> Start the turn from the far-left lane. Bicyclists can legally use the left turn lane
					for their left turns. If there are three or more lanes in your direction of travel, you may end your turn in any lane that is open.
				</p>
				<figure>
					<img
						loading="lazy"
				...
				<p>
					7. <strong>Turn at a “T” intersection from a one-way street onto a two-way street.</strong> Traffic going straight through the intersection has the
					right-of-way. You may turn either right or left from the center lane.
				</p>
				<figure>
					<img
						loading="lazy"
				...
				<ul>
					<li>
						Remove your foot from the gas pedal (accelerator) and allow the vehicle to slow down. Lightly press the brake until you come to a full stop. Give yourself
						enough space and time to perform this maneuver.
					</li>
				...
				<ul>
					...
					<li>
						Do not cross over any solid lines when merging. If you need to cross several lanes, signal and cross them one at a time. Check your blind spots for vehicles,
						motorcyclists, bicyclists, and pedestrians each time.
					</li>
				</ul>
				<h3>Exiting</h3>
				...
				<p>
					When entering traffic from a full stop, signal and leave a large enough space to get up to the speed of traffic. To merge, enter, or exit traffic, you need a
					space that is:
				</p>
				<ul>
				...
				<p>
					When turning left, do not assume that an oncoming vehicle with its right turn signal on is turning before it reaches you. The driver may have their signal on by
					mistake or plan to turn just beyond you. Wait for the vehicle to start its turn before beginning the left turn.
				</p>
				<h2>Passing</h2>
