...
const SideBar_R_QuestionNumber = () => {
	...
	const lightBulbButton = (
		<button onClick={lightBulbButtonAction} className={`${classes["footerButton"]} ${activeStatus ? classes.open : ""}`}>
			<svg className={classes.lightBulbSVG} xmlns="http://www.w3.org/2000/svg" version="1.1" id="Capa_1" viewBox="0 0 279.682 279.682">
				<g>
	...
	const bookMarkButton = (
		<button onClick={lightBulbButtonAction} className={`${classes["footerButton"]} ${activeStatus ? classes.open : ""}`}>
			<svg className={classes.bookMarkIconSvg} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
	...
	const commentBubbleButton = (
		<button onClick={lightBulbButtonAction} className={`${classes["footerButton"]} ${activeStatus ? classes.open : ""}`}>
			<svg className={classes.commentBubbleIconSvg} xmlns="http://www.w3.org/2000/svg" version="1.1" id="Capa_1" viewBox="0 0 78.667 78.667">
				<g>
	...
	const thumbsUpButton = (
		<button onClick={lightBulbButtonAction} className={`${classes["footerButton"]} ${activeStatus ? classes.open : ""}`}>
			<svg className={classes.thumbsUpIconSvg} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
	...
	const testResultsButton = (
		<button onClick={lightBulbButtonAction} className={`${classes["footerButton"]} ${activeStatus ? classes.open : ""}`}>
			<svg className={classes.testResultsIconSvg} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
		...
		<Fragment>
			...
			<div className={classes.handbook_footer_section_Outer}>
				<div className={classes.handbook_footer_section_Inner}>
					<li>{testResultsButton}</li>
					<li>{lightBulbButton}</li>
					<li>{bookMarkButton}</li>
					<li>{commentBubbleButton}</li>
					<li>{thumbsUpButton}</li>
				</div>
			</div>
		</Fragment>
	);
