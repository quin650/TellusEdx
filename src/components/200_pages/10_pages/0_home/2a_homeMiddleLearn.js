			...
			<article className={classes.right}>
				...
				<ol className={classes.content}>
					<dl className={classes.line}>
						<dt className={classes.sub_title}>SELF-GUIDED</dt>
					...
					<dl className={classes.line}>
						<dt className={classes.sub_title}>SYNCED</dt>
						<dd className={classes.sub_content}>Always find where you left off, never losing pace, always moving forward.</dd>
					</dl>
					<div className={classes.break}></div>
					<dl className={classes.line}>
						<dt className={classes.sub_title}>AUTO</dt>
						<dd className={classes.sub_content}>Turn on autopilot, and enjoy a catered learning experienced built on our communities’ hard work.</dd>
					</dl>
				</ol>
			</article>
		</div>
